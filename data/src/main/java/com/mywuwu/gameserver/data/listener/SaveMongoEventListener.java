package com.mywuwu.gameserver.data.listener;


import com.mywuwu.gameserver.data.annotation.AutoIncrement;
import com.mywuwu.gameserver.data.monoModel.SequenceId;
...
public class SaveMongoEventListener extends AbstractMongoEventListener<Object> {
     private final static Logger LOGGER =  LoggerFactory.getLogger(SaveMongoEventListener.class);
